# Documentació i codi del repositori

**Títol del TFM:** *Estudi sobre la relació entre el creixement de l'extrema dreta i la violència contra les dones*

Aquest repositori conté el material computacional, les dades originals i els models estadístics utilitzats per investigar la relació entre l’indicador de vot a l'extrema dreta i diversos indicadors de violència masclista a Espanya (2014-2023).
...
│   └── processats/     # Dataset unificat (rates_all_metrics_by_province_year_unified_final_FIXED.csv); resultats parcials dels models
├── notebooks/
